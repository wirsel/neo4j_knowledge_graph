MATCH (n:c_pocket_timeadded) 
//with n limit 10000
with tointeger(n.identifier) as epoch
with epoch, datetime({ epochSeconds:epoch }) as str
...
set n += props
with epoch, y, ym, ymd, n as ymd_h
...
set n += props
with epoch, y, ym, ymd, ymd_h, n as ymd_hm
...
set n += props
with y, ym, ymd, ymd_h, ymd_hm, n as ymd_hms
